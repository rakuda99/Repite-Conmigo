...
fun AdvancedScreen(
    ...
    Scaffold(
            ...
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = onBack) {
                        Icon(Icons.Rounded.ArrowBack, contentDescription = stringResource(R.string.back), tint = Color.Gray)
                    }
                },
        ...
        LazyColumn(
            ...
            item {
                ActionCard(
                    title = stringResource(R.string.pronunciation_challenge),
            ...
            item {
                ActionCard(
                    title = stringResource(R.string.tf_challenge),
            ...
            item {
                ActionCard(
                    title = stringResource(R.string.fill_blank_challenge),
                    icon = Icons.Rounded.Assignment,
            ...
            item {
                OutlinedActionCard(
                    title = stringResource(R.string.add_custom_lesson),
